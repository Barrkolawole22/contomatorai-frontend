...
export const settingsAPI = {
  ...
  updatePrivacy:       (data: any)  => makeRequest({ method: 'PUT',    url: '/settings/privacy',        data }),
...
export const billingAPI = {
  ...
  getUserPlan: () =>
    makeRequest({ method: 'GET', url: '/billing/plan' }),
  ...
  refreshUser: () =>
    makeRequest({ method: 'GET', url: '/billing/refresh' }),
};
...
export const authAPI = {
  ...
  forgotPassword: (email: string) => makeRequest({ method: 'POST', url: '/auth/forgot-password', data: { email } }),
  resetPassword:  (token: string, newPassword: string) =>
    makeRequest({ method: 'POST', url: '/auth/reset-password', data: { token, newPassword } }),
  deductCredits: (wordCount: number) => makeRequest({ method: 'POST', url: '/auth/deduct-credits', data: { wordCount } }),
...
export const keywordsAPI = {
  ...
  save:          (keyword: string) => makeRequest({ method: 'POST', url: '/keywords/save', data: { keyword } }),
...
export const profileAPI = {
  get:    ()           => makeRequest({ method: 'GET', url: '/profile' }),
  update: (data: any)  => makeRequest({ method: 'PUT', url: '/profile', data }),
  uploadAvatar: (formData: FormData) =>
    makeRequest({ method: 'POST', url: '/profile/avatar', data: formData, headers: { 'Content-Type': 'multipart/form-data' } }),
